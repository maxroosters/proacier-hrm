...
def genera_pdf_lavoratore(d, lingua="fr"):
    ...
    pdf.set_x(8); pdf.multi_cell(0, 6, _pdf_safe(f"Acceptation : Manuel des procédures (V{man_ver}) + Règlement intérieur + Consentement au traitement des données"), align="C")
    pdf.ln(2)
